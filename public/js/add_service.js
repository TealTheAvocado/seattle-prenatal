...
// Citation for the add service javascript using ajax: 
// Date: 11/09/2023
...
let addServiceContainer = document.getElementById('add-container');
let toggleAddServiceFormButton = document.getElementById('toggle-add-form');
...
toggleAddServiceFormButton.addEventListener("click", function () {
    ...
    if (addServiceContainer.style.display === 'block') {
        addServiceForm.scrollIntoView({ behavior: 'instant' });
    }
});
...
addRowToTable = (data) => {
    ...
    let currentTable = document.getElementById("service-table");
