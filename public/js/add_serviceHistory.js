...
// Citation for the add service histories javascript using ajax: 
// Date: 11/09/2023
// Copied from CS340 OSU course:
// Source URL: https://github.com/osu-cs340-ecampus/nodejs-starter-app

// Get the objects we need to modify
let addServiceHistoryForm = document.getElementById('add-serviceHistory-form-ajax');
...
toggleAddFormButton.addEventListener("click", function () {
    ...
    if (addContainer.style.display === 'block') {
        addServiceHistoryForm.scrollIntoView({ behavior: 'instant' });
    }
    
});


addServiceHistoryForm.addEventListener("submit", function (e) {
    ...
    let inputService = document.getElementById("myServiceSelect");
    let inputDate = document.getElementById("input-date");
    let inputEmployee = document.getElementById("myEmployeeSelect");
    ...
    xhttp.open("POST", "/add-serviceHistory-ajax", true);
...
addRowToTable = (data) => {
    ...
    let currentTable = document.getElementById("serviceHistories-table");
